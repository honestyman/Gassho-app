...
class EnSearchApp extends StatefulWidget {
  const EnSearchApp({super.key});

  static const routeName = '/en_search';

  @override
  State<EnSearchApp> createState() => _EnSearchAppState();
}

class _EnSearchAppState extends State<EnSearchApp> {
  ...
  Future<List<CategoryItem>> getAllCategory() async{
    ...
    for(var singleCategory in reasonData){
      CategoryItem category=CategoryItem(id:singleCategory["id"], name: singleCategory["en_name"], image_name: singleCategory['image_name']);
  ...
  void sendContent(){
    //  Navigator.of(context).pushNamed('/content_search');
     Navigator.pushNamed(context, EnContentSearchPage.routeName,
                arguments: SendSearchDatas(searchController.text));
  }
  void sendSearchCateoryId(int id, String title){
    Navigator.pushNamed(context, EnCategorySearchPage.routeName,
                arguments: EnSendSearchIdDatas(id, title));
  }
  void sendSearchTabId(int id, String title){
    Navigator.pushNamed(context, EnTabSearchPage.routeName,
                arguments: EnSendSearchIdDatas(id, title));
  }
  @override
