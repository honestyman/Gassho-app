...
class EnPlayPageApp extends StatefulWidget {
  const EnPlayPageApp({super.key});
  static const routeName = '/en_playpage';

  @override
  State<EnPlayPageApp> createState() => _EnPlayPageAppState();
}
...
class _EnPlayPageAppState extends State<EnPlayPageApp> {
  Future<List<Data>> getRequest() async {
    ...
    String url = "http://localhost:5000/api/items/getplay?email=$email";
