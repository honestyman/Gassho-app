...
void main() {
  runApp(const DownloadPageApp());
}

class DownloadPageApp extends StatefulWidget {
  const DownloadPageApp({super.key});
  static const routeName = '/downloadpage';

  @override
  State<DownloadPageApp> createState() => _DownloadPageAppState();
}

class _DownloadPageAppState extends State<DownloadPageApp> {
